...
class CityTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.lblCar.text = cityData.cityNames[indexPath.row]
        cell.imgCar.image = UIImage(named: cityData.cities[indexPath.row])
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let split = self.splitViewController {
            ...
            let detailViewController = controllers[controllers.count-1]
                as? CityViewController
            
            detailViewController?.updateCity(select: indexPath.row)
        }
    }
    /*
